...
results_dir = os.path.join(parent_dir, f'results_new/m10_att0/{timestamp}')
# 设置结果Excel的文件路径
results_excel_file = os.path.join(results_dir, 'm10_att0_uncertainty_results.xlsx')
...
XRD_descriptor = pd.read_csv('../data/XRD_sin_descriptor_936.csv', header=None, low_memory=False)
