...
class UA_CNN(nn.Module):
    def __init__(self):
        ...
        self.fc1_var = nn.Linear(256, 256)
        self.fc2_var = nn.Linear(256, 128)
        self.fc3_var = nn.Linear(128, 32)
        self.fc4_var = nn.Linear(32, 1)
...
results_dir = os.path.join(parent_dir, f'results_new/var3/{timestamp}')
# 设置结果Excel的文件路径
results_excel_file = os.path.join(results_dir, 'var3_uncertainty_results.xlsx')
