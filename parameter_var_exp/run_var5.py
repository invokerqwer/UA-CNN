...
class UA_CNN(nn.Module):
 ...
 # Larger fully connected layers
        ...
        # Add dropout layers with a probability of 0.5
        self.dropout = nn.Dropout(0.5)

        # For variance prediction (same size as the main prediction head)
        self.fc1_var = nn.Linear(256, 512)
        self.fc2_var = nn.Linear(512, 256)
