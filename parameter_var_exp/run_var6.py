...
class UA_CNN(nn.Module):
    def __init__(self):
        ...
        # Fully connected layers with adjusted size
        ...
        self.fc2_var = nn.Linear(512, 384)
        self.fc3_var = nn.Linear(384, 192)
        self.fc4_var = nn.Linear(192, 48)
        self.fc5_var = nn.Linear(48, 1)
