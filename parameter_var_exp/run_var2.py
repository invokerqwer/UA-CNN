...
class UA_CNN(nn.Module):
    def __init__(self):
        ...
        self.fc1_var = nn.Linear(256, 128)
        self.fc2_var = nn.Linear(128, 64)
        self.fc3_var = nn.Linear(64, 16)
        self.fc4_var = nn.Linear(16, 1)
...
results_dir = os.path.join(parent_dir, f'results_new/var2/{timestamp}')
# 设置结果Excel的文件路径
results_excel_file = os.path.join(results_dir, 'var2_uncertainty_results.xlsx')
