...
class UA_CNN(nn.Module):
    def __init__(self):
        ...
        self.fc1_var = nn.Linear(256, 32)
        self.fc2_var = nn.Linear(32, 16)
        self.fc3_var = nn.Linear(16, 4)
        self.fc4_var = nn.Linear(4, 1)
...
results_dir = os.path.join(parent_dir, f'results_new/var1/{timestamp}')
# 设置结果Excel的文件路径
results_excel_file = os.path.join(results_dir, 'var1_uncertainty_results.xlsx')
